...
//        )
        // Exemplo fazendo o parse vindo de API, imaginando que o dataRaw contem o json
...
//                ChatMessage(text: "Olá, sou o Megamil Chat!", timestamp: "05/11/2024 00:00", isFromMe: true)
            ...
            listSuggestions: "🕢 Qual horário de funcionamento?, 💲 Qual o valor da mensalidade?, 🗺️ Qual o endereço da loja?, 📆 Qual o prazo de orçamento?", /* Sugestões iniciais de perguntas (exibidas apenas quando não há histórico de mensagens) */
